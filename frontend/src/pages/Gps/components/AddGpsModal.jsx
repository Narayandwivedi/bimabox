            ...
            <div className='flex justify-between items-center'>
              ...
              <div className='flex items-center gap-3'>
                <div className='relative overflow-hidden'>
                  <button type='button' disabled={isExtractingGps} className='relative px-3 py-1.5 bg-white/20 hover:bg-white/30 text-white text-sm font-semibold rounded-lg transition disabled:opacity-50 flex items-center gap-2 max-w-full'>
                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                    </svg>
                    {isExtractingGps ? 'Extracting...' : 'AI Upload'}
                  </button>
