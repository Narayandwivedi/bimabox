...
module.exports = createRecordController({
  ...
  expiringDays: 30,
  searchFields: ['vehicleNumber', 'policyNumber', 'policyHolderName', 'mobileNumber', 'insuranceCompany'],
  stringFields: ['vehicleNumber', 'policyNumber', 'policyHolderName', 'mobileNumber', 'validFrom', 'validTo', 'issueDate', 'insuranceDocument', 'remarks', 'insuranceCompany'],
