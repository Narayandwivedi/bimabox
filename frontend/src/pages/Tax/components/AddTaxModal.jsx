          ...
          <div className='flex justify-between items-center'>
            ...
            <div className='flex items-center gap-3'>
              <div className='relative overflow-hidden'>
                <button type='button' disabled={isExtractingTax} className='relative px-3 py-1.5 bg-white/20 hover:bg-white/30 text-white text-sm font-semibold rounded-lg transition disabled:opacity-50 flex items-center gap-2 max-w-full'>
                  {isExtractingTax ? (
                    <>
                ...
                <input type='file' accept='image/*, application/pdf' disabled={isExtractingTax} onChange={handleTaxExtractionUpload} className='absolute inset-0 w-full h-full opacity-0 cursor-pointer disabled:cursor-not-allowed' />
              </div>
              <button
                onClick={onClose}
