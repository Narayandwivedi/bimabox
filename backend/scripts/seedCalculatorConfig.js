...
const initialConfigs = [
  {
    ...
    customFields: [
      ...
      { id: 'restricted_tppd', label: 'Restricted TPPD Discount', fieldType: 'fixed_amount', rate: 100, section: 'tp', isActive: true },
    ]
  },
  {
    ...
    customFields: [
      { id: 'imt23', label: 'IMT 23 Cover', fieldType: 'percent_of_od', rate: 15, section: 'od', isActive: true },
      { id: 'restricted_tppd', label: 'Restricted TPPD Discount', fieldType: 'fixed_amount', rate: 50, section: 'tp', isActive: true },
    ]
  },
  {
    vehicleType: 'gcv',
    label: 'Goods Carrying Vehicle (GCV)',
    isActive: true,
    gstRate: 18,
    gstTpRate: 5,
    tpRates: {
    ...
    customFields: [
      { id: 'imt23', label: 'IMT 23 Cover', fieldType: 'percent_of_od', rate: 15, section: 'od', isActive: true },
      { id: 'restricted_tppd', label: 'Restricted TPPD Discount', fieldType: 'fixed_amount', rate: 200, section: 'tp', isActive: true },
    ]
  },
  {
    vehicleType: 'gcv_3w',
    ...
    customFields: [
      { id: 'imt23', label: 'IMT 23 Cover', fieldType: 'percent_of_od', rate: 15, section: 'od', isActive: true },
      { id: 'restricted_tppd', label: 'Restricted TPPD Discount', fieldType: 'fixed_amount', rate: 150, section: 'tp', isActive: true },
    ]
  },
  {
    vehicleType: 'taxi',
    label: 'Taxi / Passenger Carrying (4W)',
    isActive: true,
    gstRate: 18,
    gstTpRate: 18,
    tpRates: {
  ...
  {
    vehicleType: 'pcv',
    label: 'Passenger Carrying Bus (PCV)',
    isActive: true,
    gstRate: 18,
    gstTpRate: 18,
    tpRates: {},
  ...
  {
    vehicleType: 'misc_d',
    label: 'Misc D (Tractors / Special Vehicles)',
    isActive: true,
    gstRate: 18,
    gstTpRate: 18,
    tpRates: {},
    ...
    odRates: {
      ...
      '5_to_7': { C: 1.220, B: 1.232, A: 1.268 },
...
async function seed() {
  try {
    ...
    for (const item of initialConfigs) {
      ...
      console.log(`Seeded config for ${item.vehicleType}`)
    }

    console.log('All calculator configs successfully seeded!')
    process.exit(0)
  } catch (err) {
