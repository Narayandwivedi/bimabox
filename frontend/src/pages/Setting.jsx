      ...
      <div className='mx-auto max-w-5xl'>
        ...
        <div className='flex flex-col lg:flex-row gap-6'>
          ...
          <div className='w-full lg:w-80 xl:w-96 flex-shrink-0'>
            <div className='animate-slideUp lg:sticky lg:top-6'>
              <div className='rounded-[32px] border border-slate-200 bg-white p-5 shadow-[0_28px_60px_-34px_rgba(15,23,42,0.25)] md:p-6'>
                <div className='flex flex-col items-center text-center'>
                  <div className='relative h-16 w-16 shrink-0 mb-3'>
                    <div className='h-full w-full rounded-2xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex items-center justify-center overflow-hidden text-2xl text-white font-black shadow-lg shadow-indigo-500/25'>
                      {user?.picture ? (
                  ...
                  <h2 className='text-lg font-black text-slate-900 truncate max-w-full'>{user?.name || 'User'}</h2>
                ...
                <div className='mt-5 pt-4 border-t border-slate-100 space-y-2.5'>
                  <div className='flex items-center gap-3 rounded-xl bg-gradient-to-r from-slate-50 to-slate-100/50 px-4 py-3 border border-slate-100'>
                    ...
                    <div className='min-w-0 text-left'>
                      ...
                      <p className='text-xs font-semibold text-slate-900 truncate'>{user?.mobile?.replace(/(\d{5})(\d{5})/, '$1 $2') || 'Not linked'}</p>
                    </div>
                  </div>
                  <div className='flex items-center gap-3 rounded-xl bg-gradient-to-r from-slate-50 to-slate-100/50 px-4 py-3 border border-slate-100'>
                ...
                <button
                  ...
                  className='mt-5 w-full flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white py-2.5 text-sm font-bold hover:shadow-lg hover:shadow-blue-500/25 transition-all cursor-pointer'
                >
              ...
              <div className='rounded-[32px] border border-slate-200 bg-white p-5 shadow-[0_28px_60px_-34px_rgba(15,23,42,0.25)] md:p-6'>
                ...
                >
                  ...
                  <div className='min-w-0 flex-1'>
                    <p className='text-sm font-bold text-slate-900 group-hover:text-indigo-700 transition-colors'>Client Names</p>
                    <p className='text-[10px] font-semibold text-slate-400'>Manage client names used in insurance</p>
                  </div>
