...
const { planEnforcer, incrementUsage, skipIfViaAI } = require('../middleware/planEnforcer')
...
router.post('/', skipIfViaAI(planEnforcer('manual')), skipIfViaAI(incrementUsage('manual')), controller.create)
